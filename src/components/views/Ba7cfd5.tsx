...
function Ba7cfd5({
  ...
  subtitle = "Discover comprehensive information and insights to grow your business effectively",
  ctaText = "Contact Us",
  ctaLink = "/contact",
  secondaryCtaText = "Explore Content",
  secondaryCtaLink = "/content",
  imageSrc,
  backgroundImage = "https://imagedelivery.net/W0Tyu0H3jD0178dqoxnJSA/5d1e4c59-c755-405a-9dfe-480baf104100/public",
  variant = 'centered'
}: Ba7cfd5Props) {
