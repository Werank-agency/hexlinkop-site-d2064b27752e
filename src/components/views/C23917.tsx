...
export default function C23917({
  heading = "Unlock Business Insights Today",
  description = "Discover valuable information about businesses, market trends, and growth strategies. Connect with us to explore opportunities and access the latest resources tailored for your business needs.",
  primaryButton = {
    text: "Contact Us",
    url: "/contact"
  },
