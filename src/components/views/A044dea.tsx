...
export default function A044dea({
  heading = "Connect with Business Leaders Today",
  description = "Discover valuable insights and resources to grow your business. Reach out to our experts for tailored advice and information that drives success.",
  primaryButton = {
    text: "Contact Us",
    url: "/contact"
  },
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary via-primary/90 to-accent p-12 shadow-2xl lg:p-16">
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-white/20 px-4 py-2 backdrop-blur-sm">
              ...
              <span className="text-sm font-medium text-white">Business Insights</span>
            </div>
